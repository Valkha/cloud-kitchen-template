    ...
    <AnimatePresence>
      {totalItems > 0 && (
        ...
        >
          ...
          >
            {/* Badge Quantité */}
            <div className="absolute -top-3 -right-3 w-8 h-8 bg-brand-primary text-white text-[10px] font-black rounded-full flex items-center justify-center border-4 border-[#080808] group-hover:rotate-12 transition-transform shadow-lg">
              {totalItems}
            </div>

            <div className="flex items-center gap-3 border-r border-black/10 pr-6">
              <ShoppingBag size={20} className="group-hover:text-brand-primary transition-colors" />
