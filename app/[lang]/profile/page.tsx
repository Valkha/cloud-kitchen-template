        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-32 text-center space-y-6 bg-neutral-900/30 border border-neutral-800 rounded-3xl p-8 shadow-2xl">
            ...
            <button 
              ...
              className="bg-brand-primary text-white px-8 py-4 rounded-full font-bold uppercase tracking-widest hover:opacity-90 transition-all"
            >
              Se connecter
            </button>
          </div>
          ...
          <>
            ...
            >
              <div className="w-24 h-24 bg-brand-primary/10 rounded-full flex items-center justify-center border-2 border-brand-primary shadow-lg">
